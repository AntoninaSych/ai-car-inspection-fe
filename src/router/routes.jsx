...
const ForgotPasswordRequestPage = lazy(() => import('../features/forget-password/pages/ForgotPasswordRequestPage'));
const ResetPasswordPage = lazy(() => import('../features/forget-password/pages/ResetPasswordPage'));
